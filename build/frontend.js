...
/*!*****************************************!*\
  !*** ./src/block/animation/frontend.js ***!
  \*****************************************/
...
const delay = ['none', 'delay-100ms', 'delay-200ms', 'delay-500ms', 'delay-1s', 'delay-2s', 'delay-3s', 'delay-4s', 'delay-5s'];
...
window.addEventListener('load', () => {
  ...
  window.addEventListener('scroll', () => {
    for (const element of elements) {
      if (element.getBoundingClientRect().top <= window.innerHeight * 0.95 && 0 < element.getBoundingClientRect().top) {
