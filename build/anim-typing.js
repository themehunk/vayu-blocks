...
!function() {
/*!******************************************************!*\
  !*** ./inc/block/animation/frontend/typing/index.js ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
...
const initTyping = elem => {
  ...
  const totalTime = ((config === null || config === void 0 ? void 0 : config.speed) || 0.1) * len;
  const {
    start,
    steps,
    stop
  } = (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.makeInterval)(totalTime, (config === null || config === void 0 ? void 0 : config.speed) || 0.1);
