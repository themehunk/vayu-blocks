...
const BlockAnimation = (el, props) => {
  if ((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.hasBlockSupport)(props.name, 'customClassName', true) && !excludedBlocks.includes(props.name)) {
    var _select;
    const showAsDefault = Boolean((_select = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.select)('core/preferences')) === null || _select === void 0 ? void 0 : _select.get('themeisle/otter-blocks', 'show-animations'));
