...
$menu_classes  = 'wp-block-vayu-blocks-mega-menu__menu-container';
...
>
	<button
		class="wp-block-vayu-blocks-mega-menu__toggle"
		data-wp-on--click="actions.toggleMenuOnClick"
		data-wp-bind--aria-expanded="state.isMenuOpen"
	>
		<?php echo $label; ?><span class="wp-block-vayu-blocks-mega-menu__toggle-icon"><?php echo $toggle_icon; ?></span>
	</button>
	...
	<?php if ( $disable_when_collapsed && $collapsed_url ) { ?>
		<a class="wp-block-vayu-blocks-mega-menu__collapsed-link" href="<?php echo $collapsed_url; ?>">
