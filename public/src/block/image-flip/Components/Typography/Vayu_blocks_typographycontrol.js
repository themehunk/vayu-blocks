            ...
            <ToolsPanel label={__(label)} resetAll={resetAll ? handleResetAll : undefined}>
                ...
                {includeFont && (
                    <ToolsPanelItem
                        ...
                        label={__(toSentenceCase(fontLabel), 'vayu_blocks')}
                    >
                        <SelectControl
                ...
                {includeSize && (
                    <ToolsPanelItem
                        hasValue={() => !!true}
                        label={__(toSentenceCase(sizeLabel), 'vayu_blocks')}
                    >
                        <FontSizePicker
                ...
                <div className="vayu_blocks_size_all">
                    {includeAppearance && (
                        <ToolsPanelItem
                            ...
                            label={__(toSentenceCase(appearanceLabel), 'vayu_blocks')}
                        >
                            <SelectControl
                    ...
                    {includeLineHeight && (
                        <ToolsPanelItem
                            hasValue={() => !lineHeight}
                            label={__(toSentenceCase(lineHeightLabel), 'vayu_blocks')}
                        >
                            <LineHeightControl
                    ...
                    {includeLetterSpacing && (
                        <ToolsPanelItem
                            ...
                            label={__(toSentenceCase(letterSpacingLabel), 'vayu_blocks')}
                        >
                    ...
                    {includeTextDecoration && (
                        <ToolsPanelItem
                            hasValue={() => !true}
                            label={__(toSentenceCase(textDecorationLabel), 'vayu_blocks')}
                        >
                ...
                {includeLetterCase && (
                    <ToolsPanelItem
                        hasValue={() => !true}
                        label={__(toSentenceCase(letterCaseLabel), 'vayu_blocks')}
                    >
