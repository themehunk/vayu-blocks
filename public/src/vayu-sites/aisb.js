...
function Version(){
 ...
 function Upgrade(props) {
    return (<>{props.btn && <a href={VAYUB.upgrade} target='_blank'>
...
function Logo() {
    ...
    <a href={`${VAYUB.baseurl}wp-admin/admin.php?page=vayu-sites`}><img src={VAYUB.rootPath+"inc/assets/img/logo-vayu.png"} alt="Vayu Logo" /></a>
    </div>)
    }
