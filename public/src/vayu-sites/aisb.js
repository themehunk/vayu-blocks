...
import {PluginStatusChecker} from '../vayu-sites/template/PluginStatusChecker';
...
function Logo() {
    ...
    <a href={`${AISB.baseurl}wp-admin/admin.php?page=vayu-sites`}><img src={AISB.rootPath+"inc/assets/img/logo-vayu.png"} alt="Vayu Logo" /></a>
    </div>)
    }
...
Upgrade.defaultProps = {
  ...
  export { Upgrade,HomeLink,Logo,Version };
