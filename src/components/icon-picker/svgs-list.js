...
const svgs = {
	clock: {
		label: _x( 'Clock', 'label', 'themehunk-block' ),
	...
	clockAlt: {
		label: _x( 'Clock Outline', 'label', 'themehunk-block' ),
		icon: <svg aria-hidden="true" role="img" height="1em" width="1em" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z" /></svg>,
	},
	asterisk: {
		label: _x( 'Asterisk', 'label', 'themehunk-block' ),
	...
	at: {
		label: _x( 'At', 'label', 'themehunk-block' ),
	...
	award: {
		label: _x( 'Award', 'label', 'themehunk-block' ),
	...
	bullhorn: {
		label: _x( 'Bullhorn', 'label', 'themehunk-block' ),
	...
	bullseye: {
		label: _x( 'Bullseye', 'label', 'themehunk-block' ),
	...
	burn: {
		label: _x( 'Burn', 'label', 'themehunk-block' ),
	...
	calendarAlt: {
		label: _x( 'Calender', 'label', 'themehunk-block' ),
	...
	check: {
		label: _x( 'Check', 'label', 'themehunk-block' ),
	...
	circle: {
		label: _x( 'Circle', 'label', 'themehunk-block' ),
	...
	circleOutline: {
		label: _x( 'Circle - Outline', 'label', 'themehunk-block' ),
	...
	dotCircleOutline: {
		label: _x( 'Dot - Circle Outline', 'label', 'themehunk-block' ),
	...
	ellipsesH: {
		label: _x( 'Ellipses - Horizontal', 'label', 'themehunk-block' ),
		icon: <svg aria-hidden="true" role="img" height="1em" width="1em" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z" /></svg>,
	},
	ellipsesV: {
		label: _x( 'Ellipses - Vertical', 'label', 'themehunk-block' ),
	...
	plusSquareOutline: {
		label: _x( 'Plus - Square Outline', 'label', 'themehunk-block' ),
	...
	linkedin: {
		label: _x( 'LinkedIn', 'label', 'themehunk-block' ),
	...
	pinterestCircle: {
		label: _x( 'Pinterest - Circle', 'label', 'themehunk-block' ),
	...
	pinterestSquare: {
		label: _x( 'Pinterest - Square', 'label', 'themehunk-block' ),
	...
	reddit: {
		label: _x( 'Reddit', 'label', 'themehunk-block' ),
	...
	redditCircle: {
		label: _x( 'Reddit - Circle', 'label', 'themehunk-block' ),
	...
	redditSquare: {
		label: _x( 'Reddit - Square', 'label', 'themehunk-block' ),
	...
	snapchat: {
		label: _x( 'Snapchat', 'label', 'themehunk-block' ),
	...
	soundcloud: {
		label: _x( 'Soundcloud', 'label', 'themehunk-block' ),
	...
	twitterSquare: {
		label: _x( 'Twitter - Square', 'label', 'themehunk-block' ),
	...
	whatsapp: {
		label: _x( 'WhatsApp', 'label', 'themehunk-block' ),
	...
	whatsappSquare: {
		label: _x( 'WhatsApp - Square', 'label', 'themehunk-block' ),
	...
	youtube: {
		label: _x( 'YouTube', 'label', 'themehunk-block' ),
